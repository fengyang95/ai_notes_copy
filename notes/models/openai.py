...
# )
#
# from llm_api.chatgpt import query_gpt
...
#         try:
#             prompt = await token_handler(self.config, index, prompt, tokens)  # todo 这个地方需要修改一下
#             parameters = await self._build_payload(prompt, tokens)
#             text = query_gpt(parameters)
...
#         #         "http://chatverse.bytedance.net/v1/chat",  # added by xj
#         #         headers={'Authorization': 'Bearer f9489dedd8d066940593639ee4853a20'},
#         #         json=parameters,
#         #     ) as response:
