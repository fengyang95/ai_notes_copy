...
from notes.parsers.factory import parser_handler

_github_actions_path = ".github/workflows"
"""
.github/workflows 目录是用于定义 GitHub Actions 工作流的目录，并且通常包含在 .github/workflows/ 路径下。GitHub Actions 是 GitHub 的CI/CD（持续集成和持续部署）平台，它允许开发者自动化构建、测试和部署他们的代码。
"""
