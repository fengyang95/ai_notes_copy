...
from notes._exceptions import FileReadError, FileWriteError
...
if __name__ == '__main__':
    file_path = "/Users/bytedance/PycharmProjects/devops_copilot_demo/config/settings/config.toml"
    file_handler = FileHandler()
    result = file_handler.read(file_path)
    pass
